...
%The back propagation algorithm in a Neural Network computes the gradient of error of the network $E$, given as the difference between the expected and calculated values, and the network's weights $w_{i,j}$ as shown in Eq. \ref{learning_rate}.
%
%\begin{equation}
%\Delta w_{i,j}=\frac{\delta E}{\delta w_{i,j}}
%\label{learning_rate}
%\end{equation}
%
%Using the change
